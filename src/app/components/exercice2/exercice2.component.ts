...
export class Exercice2Component implements OnInit {
    ...
    mySlideOptions={
        ...
        nav:true,
        navText: [
            '<p style="position: absolute;top: 100px;left: -50px"><img style="border: 2px solid #fd0041;padding: 5px 0" width="32" src="https://s2.gulfupload.com/i/00099/piuh61mjvfmu.png"/></p>',
            '<p style="position: absolute;top: 100px;right: -50px"><img style="border: 2px solid #fd0041;padding: 5px 0" width="32" src="https://s2.gulfupload.com/i/00099/xabkt0j628cy.png"/></p>' ],
        };
